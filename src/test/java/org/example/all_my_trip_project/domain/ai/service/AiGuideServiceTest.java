...
class AiGuideServiceTest {
    ...
    void sendsUsersRecentHistoryToModelAndStoresSuccessfulResponse() {
        AiGuideRequest request = new AiGuideRequest("음식점도 두 개 추가해줘");
    ...
    void doesNotStoreConversationWhenAiGenerationFails() {
        AiGuideRequest request = new AiGuideRequest("?ㅻ쪟 諛쒖깮 ?뚯뒪??");
        ...
        verify(conversationHistoryService, never()).append(org.mockito.ArgumentMatchers.anyLong(), org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.anyString());
    }
}
