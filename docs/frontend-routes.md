...
| `/trips/new/plan` | `trips/plan.html` |
| `/trips/new/basic` | `trips/basic.html` |
| `/trips/new/style` | `trips/style.html` |
| `/trips/schedule` | `trips/schedule.html` |
| `/trips/{tripId}/schedule` | `trips/schedule.html` |
...
| `/ai-trip-plan` | `guide/ai-trip-plan.html` |
| `/booking/flights` | `booking/flights.html` |
| `/booking/tickets/{ticketProductId}` | `booking/ticket.html` |
| `/booking/queue` | `booking/queue.html` |
| `/pay/toss` | `payment/toss-return.html` |
| `/pay/kakao` | `payment/kakao-return.html` |
| `/pay/qr` | `payment/qr-approve.html` |
| `/mypage` | `mypage/mypage.html` |
| `/admin` | `admin/admin.html` |
| `/admin/places` | `admin/places.html` |
| `/admin/scan` | `admin/scan.html` |

화면을 그리지 않고 넘기기만 하는 주소도 있다. `/`는 `/home`으로, `/booking`은 `/booking/flights`로, `/booking/hotels`는 `/booking/flights?tab=hotel`로 보낸다.
...
| 관리자 테마 등록 | `travel_themes`, `travel_theme_styles`, `travel_theme_places`, `places` |
